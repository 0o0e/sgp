...
<div class="container">
    ...
    <form action="{{ route('children.store') }}" method="POST" enctype="multipart/form-data" class="child-form">
        @csrf
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="eye_color" name="eye_color" value="{{ old('eye_color') }}">
            </div>

            <div class="form-group">
                <label for="hair_color">Hair Color</label>
                <input type="text" id="hair_color" name="hair_color" value="{{ old('hair_color') }}">
            </div>

            <div class="form-group">
                <label for="hair_length">Hair Length</label>
                <input type="text" id="hair_length" name="hair_length" value="{{ old('hair_length') }}">
            </div>

            <div class="form-group">
                <label for="distinguishing_features">Distinguishing Features</label>
                <textarea id="distinguishing_features" name="distinguishing_features">{{ old('distinguishing_features') }}</textarea>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea id="appearance_before" name="appearance_before">{{ old('appearance_before') }}</textarea>
            </div>

            <div class="form-group">
                <label for="appearance_after">Appearance After</label>
                <textarea id="appearance_after" name="appearance_after">{{ old('appearance_after') }}</textarea>
            </div>

            <div class="form-group">
                <label for="before_image">Before Image</label>
                <input type="file" id="before_image" name="before_image" accept="image/*">
                <div id="before_image_preview" class="image-preview"></div>
            </div>

            <div class="form-group">
                <label for="after_image">After Image</label>
                <input type="file" id="after_image" name="after_image" accept="image/*">
                <div id="after_image_preview" class="image-preview"></div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea id="family" name="family">{{ old('family') }}</textarea>
            </div>

            <div class="form-group">
                <label for="school">School</label>
                <textarea id="school" name="school">{{ old('school') }}</textarea>
            </div>
